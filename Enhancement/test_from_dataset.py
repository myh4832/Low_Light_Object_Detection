...
parser.add_argument('--input_dir', default='/home/myhong/LOD/val2017',
...
psnr = []
ssim = []
if dataset in ['SID', 'SMID', 'SDSD_indoor', 'SDSD_outdoor', 'COCO']:
    ...
    if dataset == 'SID':
        ...
        from basicsr.data.COCO_dataset import Dataset_COCO as Dataset
    else:
