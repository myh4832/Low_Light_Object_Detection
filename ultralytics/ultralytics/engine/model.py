...
class Model(nn.Module):
    ...
    def predict(
        ...
        **kwargs,
        ...
        return self.predictor.predict_cli(source=source, model_restoration=self.model_restoration) if is_cli else self.predictor(source=source, stream=stream, model_restoration=self.model_restoration)
    ...
    def val(
        ...
        **kwargs,
        ...
        validator(model=self.model, model_restoration=self.model_restoration)
    ...
    def train(
        ...
        **kwargs,
        ...
        self.trainer.train(model_restoration=self.model_restoration)
